...
<div class="main">
		  ...
		  <form method="POST" class="form" id="form-1">
			...
			<div class="form-group">
                ...
                <input id="email" name="email" type="text" class="form-control" placeholder="123@abc.com">
            ...
            <div class="form-group">
                ...
                <input id="password_check" name="password_check" placeholder="Re-enter password" type="password" class="form-control">
                <span class="form-message"></span>
                </div>
            ...
            <div class="form-group">
                <label for="zip" class="form-label">Identification number</label>
