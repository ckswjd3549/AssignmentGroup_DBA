                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class='list-group' id='cat-list'>
                            ...
                            <?php
                            $cat = $pdo->query("SELECT * FROM category order by name asc");
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            $cat = $pdo->query("SELECT * FROM product where unix_timestamp(bid_end_time) >= ".strtotime(date("Y-m-d H:i"))." $where order by name asc");
                            if($cat->num_rows <= 0){
                                ...
                                <div class="col-sm-4">
                                    <div class="card">
                                        <div class="float-right align-top bid-tag">
                                            <span class="badge badge-pill badge-primary text-white"><i class="fa fa-tag"></i> <?php echo number_format($row['bod_start_time']) ?></span>
                                        </div>
                                        <img class="card-img-top" src="admin/assets/uploads/<?php echo $row['image'] ?>" alt="Card image cap">
                                        <div class="float-right align-top d-flex">
                                            <span class="badge badge-pill badge-warning text-white"><i class="fa fa-hourglass-half"></i> <?php echo date("M d,Y h:i A",strtotime($row['bid_end_time'])) ?></span>
                                        </div>
